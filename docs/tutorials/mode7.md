...
### Basic rotation + scaling — `examples/mode7/mode7`
...
### F-Zero perspective via HDMA — `examples/mode7/mode7_perspective`
...
- `lib/source/mode7.asm` — implementation (matrix multiply, sin/cos
  table).
- [`examples/mode7/mode7`](../../examples/mode7/mode7/README.md) — basic rotation + scaling demo.
- [`examples/mode7/mode7_perspective`](../../examples/mode7/mode7_perspective/README.md) — F-Zero-style perspective via 4-channel HDMA.
...
`mode7/mode7_perspective` drives M7A/M7D per line for the
F-Zero ground; `mode7/mode7_perspective_rotate` drives the FULL
