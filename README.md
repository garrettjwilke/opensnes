...
OpenSNES lets you write Super Nintendo games in **standard C11** — no proprietary toolchain, no assembly required to get started. One `make` command builds the compiler, tools, library, and all 73 example ROMs.
...
| **73 examples** | From "Hello World" to Tetris with music — each with README and screenshot |
...
73 examples organized as a progressive learning path — backgrounds, sprites, scrolling, HDMA effects, audio, input, save games, and complete games.
