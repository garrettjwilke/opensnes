...
luna v1.9.0 · `luna state -n <steps>` per ROM · 74 ROMs · **72 OK, 2 INPUT-DEP, 0 DEAD, 0 FAIL**
...
| `graphics/effects/direct_color` | OK | live (122f/121nmi) |
