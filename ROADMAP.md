...
produces code 30 % faster than PVSnesLib + 816-opt on the benchmark suite. 82
...
- [x] [`compiler/PINS.md`](compiler/PINS.md) — pinned submodule SHAs +
      local-patch lists
- [x] Example READMEs with hardware explanations (82 / 82)
...
*Last updated: 2026-08-01. Anchored claims (version, examples count, framework
